  ...
  return (
    ...
    >
      ...
      <div className="container w-9/12 pt-8">
        ...
        <div class="-mx-3 md:flex items-start mt-8 ">
            ...
            <div class="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
              <div class="w-full flex mb-4 items-center">
                ...
                <div class="flex-grow pl-3">
                  <h6 class="font-bold text-base uppercase text-gray-600">
                    Kenzie Edgar.
                  </h6>
                </div>
              </div>
      ...
      <footer class="bg-white w-full border-t mt-5">
        <div class="mx-auto max-w-screen-2xl space-y-8 px-10 py-10 sm:px-10 lg:space-y-16 lg:px-8 ">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 text-lg">
            <div>
          ...
          <p class="text-sm text-gray-500">
            &copy; 2023. Gigs. All rights reserved.
          </p>
        </div>
      </footer>
      {/* hero end */}
