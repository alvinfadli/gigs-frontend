...
import { Briefcase, Activity, Users2, PersonStanding } from "lucide-react";
...
// export default function HrActiveJobs() {
...
//                 <a
//                   className={`rounded-full focus:outline-none  ml-2 sm:ml-8 ${
//                     selectedJobType === "All" ? "bg-orange-100" : ""
//                   }`}
//                   href="#"
//                   onClick={() => setSelectedJobType("All")}
//                 >
//                   <div className="py-2 px-8 text-orange-700 rounded-full">
//                     <p>All</p>
//                   </div>
//                 </a>
//                 <a
//                   className={`rounded-full focus:outline-none  ml-2 sm:ml-8 ${
//                     selectedJobType === "FULL_TIME" ? "bg-orange-100" : ""
//                   }`}
//                   href="#"
//                   onClick={() => setSelectedJobType("FULL_TIME")}
//                 >
...
//                 <a
//                   className={`rounded-full focus:outline-none  ml-2 sm:ml-8 ${
//                     selectedJobType === "INTERNSHIP" ? "bg-orange-100" : ""
//                   }`}
//                   href="#"
...
//                 <a
//                   className={`rounded-full focus:outline-none  ml-2 sm:ml-8 ${
//                     selectedJobType === "CONTRACT" ? "bg-orange-100" : ""
//                   }`}
//                   href="#"
...
//                                     {convertTextToTitleCase(job.jobType)}
//                                   </p>
//                                 </div>
//                               </td>
//                               <td className="pl-5">
